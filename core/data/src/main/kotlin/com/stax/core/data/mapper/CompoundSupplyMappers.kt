 ...
 */
fun CompoundSupplyEntity.toDomain(opened: OpenedContainerEntity? = null): CompoundSupply =
    CompoundSupply(
        id = id,
        name = name,
...
fun CompoundSupply.toEntity(): CompoundSupplyEntity =
...
fun OpenedContainerEntity.toDomain(): OpenedContainer =
    OpenedContainer(
        openedAt = openedAt,
 ...
 */
fun OpenedContainer.toEntity(id: Long, compoundSupplyId: Long): OpenedContainerEntity =
