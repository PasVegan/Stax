...
internal fun DbEscalationIncreaseEvery.toDomain(): EscalationIncreaseEvery =
    EscalationIncreaseEvery.valueOf(name)

internal fun EscalationIncreaseEvery.toEntity(): DbEscalationIncreaseEvery =
    DbEscalationIncreaseEvery.valueOf(name)
...
internal fun DbScheduledDoseStatus.toDomain(): ScheduledDoseStatus =
    ScheduledDoseStatus.valueOf(name)

internal fun ScheduledDoseStatus.toEntity(): DbScheduledDoseStatus =
    DbScheduledDoseStatus.valueOf(name)

internal fun DbAdministrationEventStatus.toDomain(): AdministrationEventStatus =
...
internal fun DbInventoryTransactionType.toDomain(): InventoryTransactionType =
    InventoryTransactionType.valueOf(name)

internal fun InventoryTransactionType.toEntity(): DbInventoryTransactionType =
    DbInventoryTransactionType.valueOf(name)
