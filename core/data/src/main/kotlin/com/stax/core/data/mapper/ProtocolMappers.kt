 ...
 */
fun ProtocolEntity.toDomain(dosageTimes: List<LocalTime> = emptyList()): Protocol = Protocol(
    id = id,
    name = name,
...
private fun ScheduleEmbed.toDomain(selectedWeekdaysBitmask: Int): Schedule = Schedule(
    type = type.toDomain(),
    interval = interval,
...
private fun Schedule.toEmbed(): ScheduleEmbed = ScheduleEmbed(
    type = type.toEntity(),
    interval = interval,
    timesPerDay = timesPerDay,
    timesPerWeek = timesPerWeek,
...
private fun Escalation.toEmbed(): EscalationEmbed = EscalationEmbed(
...
private fun ProtocolBreak.toEmbed(): ProtocolBreakEmbed = ProtocolBreakEmbed(daysOn = daysOn, daysOff = daysOff)
